...
from .entities.InhibitorAnnotator import InhibitorAnnotator
from .entities.GenewikiAnnotator import GenewikiAnnotator
from .entities.UniprotgeneAnnotator import UniprotgeneAnnotator
from .entities.UniprotproteinAnnotator import UniprotproteinAnnotator

class BioNounAnnotator:
    ## This is the class name that you need to use in the controller.

    supports = ('text', 'table', )

    _DATA_FIELDS = {
        'inhibitor':["word_index"]
        }

    _ent_annotator_classes = [
        InhibitorAnnotator,
        GenewikiAnnotator,
        UniprotgeneAnnotator,
